...
router.get('/countries', getBrandCountries) // lay countries 
router.get('/:id', getBrandById)
router.post('/', brandLogoUpload, brandValidator, createBrand)
router.put('/:id', brandLogoUpload, brandValidator, updateBrand)
